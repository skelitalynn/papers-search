...
> 更新：2026-08-26 ｜ 读完本文 1～3 分钟，即可掌握项目全貌。
> 定位：把「调研 → 验证 → 沉淀」方法论固化为可复用项目骨架（文档 + 脚本 + 模板），适用于技术框架选型、2025 年及以后论文检索、竞品对比。
> 关联：[docs/调研链路.md](docs/调研链路.md)（方法论）｜ [docs/用户偏好与记忆.md](docs/用户偏好与记忆.md)（协作偏好）｜ [templates/调研报告模板.md](templates/调研报告模板.md)（报告模板）

---

结论：这是一个可重复使用的论文与技术框架调研骨架。复制模板、执行七步调研链路、用脚本留下可复核证据，即可完成一次"调研、验证、沉淀"闭环。

适用场景包括技术框架选型、2025 年及以后论文检索、竞品对比。研究判断由人负责；项目只约束证据来源、源码验证和交付质量。
